...
if uploaded_file:
    ...
    display_img.thumbnail((300, 300))  # 👈 控制正在裁切圖的最大長寬（可調）
    ...
    st.image(cropped_img, caption="裁切後（分析範圍）", width=100)
    ...
    st.image(Image.fromarray(overlay), caption="分割疊圖：暗=紅、淺=青", width=100)
